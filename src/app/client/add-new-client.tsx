...
import { sources, caseworkers, companies, ranks, customerTypes, countries, cities } from './fake-data'
...
import { PlusCircle, User, UserCheck2, Building2, CalendarIcon } from 'lucide-react'
    ...
    return (
        ...
        <Dialog>
            <DialogTrigger asChild>
                <Button className="h-8 mx-2 px-2 lg:px-3"> Add new
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormControl>
                                        <RadioGroup defaultValue={field.value} className="flex space-x-5">
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className="flex justify-between flex-1 flex-col">
                                        ...
                                        <FormControl>
                                            <Popover open={caseworkerOpen} onOpenChange={setCaseworkerOpen}>
                                                <PopoverTrigger asChild>
                                                    <Button
                                                        variant="outline"
                                                        role="combobox"
                                                    ...
                                                    >
                                                        {field.value
                                                            ? caseworkers.find((caseworker) => caseworker.value === field.value)?.name
                                                            : "-- Select --"}
                                                        <CaretSortIcon className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                                                    </Button>
                                                </PopoverTrigger>
                                                <PopoverContent className="w-full p-0">
                                                    <Command>
                                                        <CommandInput placeholder="Search caseworker..." className="h-9" />
                                                        ...
                                                        <CommandGroup>
                                                            {caseworkers.map((caseworker) => (
                                                                ...
                                                                >
                                                                    ...
                                                                    <div>
                                                                        <p className="font-medium">{caseworker.name}</p>
                                                                    ...
                                                                    <CheckIcon
                                                                        className={cn(
                                                                            "ml-auto h-4 w-4",
                                                                            field.value === caseworker.value ? "opacity-100" : "opacity-0"
                                                                        )}
                                                                    />
                                                                </CommandItem>
                                                            ))}
                        ...
                        >
                            ...
                            <div className="flex justify-center space-x-4 px-4">
                                <CollapsibleTrigger asChild>
                                    <Button variant="ghost" className="text-blue-500 w-auto" size="sm">
                                                ...
                                                <FormControl>
                                                    <Select onValueChange={field.onChange}>
                                                        ...
                                                        <SelectContent>
                                                            ...
                                                            <SelectItem value="null" >-- Select --</SelectItem>
                                                            {customerTypes && customerTypes.map(data => (
                                                ...
                                                <FormControl>
                                                    <Popover open={cityOpen} onOpenChange={setCityOpen}>
                                                        <PopoverTrigger asChild>
                                                            ...
                                                            >
                                                                {field.value
                                                                    ? cities.find((city) => city.value === field.value)?.value
                                                                    : "-- Select --"
                                                                }
                                                                <CaretSortIcon className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                                                            </Button>
                        ...
                        <Button className="float-right" type="submit">Create customer</Button>
                    </form>
                </Form>
            </DialogContent>
        </Dialog>
